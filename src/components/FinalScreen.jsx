...
export default function FinalMessageScreen() {
  ...
  const messages = [
    "Happy Friendship Day, Bugaldana..❤️",
    "mana bonding eppudu yela untadho Naku theyledhu gani..",
    "But one thing is true : ",
    "oka veylla mana iddari bonding madayalo entha pedda issue vachina inka Dani valla relation pothahdi ani bhadha veusthadhi by God cares ala eppudu antha varuku ralley ..😌😌",
    "You might feel like —",
    "nenu mataladakpothey emi vedu vero vallatho mataldukontadu ani..",
    "oka veylla alagey nenu padi mandi tho mataldukonney vadini iethey nuvu msg peytina ventaney reply eccheyvadini kadhu and call lift cheyakunda undey vadini kadhu .. 😔😔",
    "And one thing is for sure:",
    "edho oka roju bonding aneydhi end avvuthadhi kani unna ani rojulu happy undam rah..",
    "oka appudu manam boldu annukunam akkadakiki veldham ekkadiki veldham ala may be annukonna annavi jarguthadho ledo naku theyeldhu kani naku matram avvi ani true nijam cheyali ani udhi rah..🥹🥹",
    "And that’s all, rah...",
    "and that it rah Ella cheypukontu pothey boldu untayii kani chala miss avvuthunanu rah ninnu Enduku theyledhu... 🥹🥹",
    "But whatever the reason is — it’s everything. 💛",
  ]
